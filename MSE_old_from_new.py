...
load_prior_network = "./Battery_Data/new_battery_cycles/Battery_RNN_from_prior_mse_v4_part_10.mdl"
save_network = "./Battery_Data/degraded_battery_cycles/Battery_RNN_from_new_mse_v1"
